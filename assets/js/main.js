...
const profile = {
  ...
  city: "揭阳-广州",
  bio:
    "长期从事软件项目管理、系统实施、业务需求分析与解决方案设计工作，熟悉企业数字化系统建设。近来重点关注 AI 工具在软件研发、投标方案、需求分析、项目管理和效率提升中的应用，希望通过 AI 与行业经验结合，提升个人和团队的数字化服务能力。",
  hobbies: ["户外露营", "曾是球场追风少年", "AI应用"],
  tags: ["AI应用", "项目管理", "软件实施", "解决方案"],
};
